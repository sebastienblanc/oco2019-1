...
public class TestPosValidator {
    ...
    public void testActivePos() throws Exception {
        Assertions.assertTrue(posValidator.isActive("POS-01"));
    }

    @Test
    public void testUnknownPos() {
        Assertions.assertFalse(posValidator.isActive("POS-99"));
    }

    @Test
    public void testInactivePos() {
        Assertions.assertFalse(posValidator.isActive("POS-03"));
    }
